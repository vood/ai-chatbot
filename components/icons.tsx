...
export const SpeakerIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M9.5 1.5L5.5 4.5H3C2.44772 4.5 2 4.94772 2 5.5V10.5C2 11.0523 2.44772 11.5 3 11.5H5.5L9.5 14.5C9.60545 14.5798 9.74753 14.6058 9.87541 14.57C10.0033 14.5343 10.1033 14.4417 10.1495 14.3227C10.1957 14.2037 10.1831 14.0695 10.1154 13.961L10 14V2C10 1.72386 9.77614 1.5 9.5 1.5ZM12 5.5C12 5.22386 12.2239 5 12.5 5C12.7761 5 13 5.22386 13 5.5V10.5C13 10.7761 12.7761 11 12.5 11C12.2239 11 12 10.7761 12 10.5V5.5ZM14.5 4C14.7761 4 15 4.22386 15 4.5V11.5C15 11.7761 14.7761 12 14.5 12C14.2239 12 14 11.7761 14 11.5V4.5C14 4.22386 14.2239 4 14.5 4Z"
      fill="currentColor"
    />
  </svg>
);
