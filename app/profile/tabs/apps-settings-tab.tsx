    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure settings for your shared applications and content.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This ID will be used to track visitors to your shared
                      content in addition to our analytics.
                    </FormDescription>
                  </FormItem>
                )}
              />
            ...
            <div className="border-b pb-6">
              <div className="flex items-center gap-2 mb-4">
                <h3 className="text-lg font-medium">
                  Disable &quot;Built with ChatLabs&quot; Banner
                </h3>
                <InfoCircle className="h-5 w-5 text-muted-foreground" />
              </div>
                  ...
                  <FormItem>
                    <FormControl>
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <span>
                          {field.value ? 'Banner disabled' : 'Banner enabled'}
                        </span>
                      </div>
                    </FormControl>
                  </FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="mt-2">
                      Artifacts make it easy to work with significant pieces of
                      content that you may want to modify, build upon, or
                      reference later.
                    </FormDescription>
                  </FormItem>
                )}
